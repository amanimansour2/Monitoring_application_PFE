...
def get_freecommu(id1):
    try:
        ...
        COMMAND="scp -oPubKeyAuthentication=no %s %s:%s " % ("/home/amani/projet/PFE/monitoring_app/scripttest/testcall.py", remotehost, "/home/amani")
        ...
        s.sendline('su -')
        s.sendline('amani')
        s.sendline("python /home/amani/testcall.py  %s " % (ch))   # run a command
