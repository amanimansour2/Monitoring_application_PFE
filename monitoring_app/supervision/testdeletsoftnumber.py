...
import sys
import json
def get_delsoftnumber(number,id1):
    try:
        ...
        COMMAND="scp -oPubKeyAuthentication=no %s %s:%s " % ("/home/amani/projet/PFE/monitoring_app/scripttest/removesoftnumber.py", remotehost, "/home/%s" %(user))
